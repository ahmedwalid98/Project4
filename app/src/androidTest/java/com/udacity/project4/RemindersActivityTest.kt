...
class RemindersActivityTest : AutoCloseKoinTest() {// Extended Koin Test - embed autoclose @after method to close Koin after every test
    ...
    /* test the snackbar by using activity scenario to launch the activity
    and then perform click on the fab and the save reminder
    then match if the snack bar is displayed if there is error
     */
    @Test
    ...
    /* test the toast message using the activity scenario
    when we perform edit on reminder by replacing text the toast message should display
    and that's what i check
     */
    @Test
