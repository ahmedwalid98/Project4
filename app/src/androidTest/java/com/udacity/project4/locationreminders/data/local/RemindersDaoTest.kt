...
class RemindersDaoTest {
    ...
    /* testing the insert reminder function by using a variable of reminder dto
        and then use the dao to save the object then matching the results and see if they match
     */
    @Test
